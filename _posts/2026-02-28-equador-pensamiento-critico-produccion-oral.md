...
tags: ["Equador", "Inglés", "Estrategias de Pensamiento Crítico", "Producción Oral", "Investigación-Acción", "Educación Superior", "Debate", "Interacción"]
link_externo: "https://revistapublicando.org/revista/index.php/crv/article/view/2121"
---

# {{ page.title }}

**Autoras:** {{ page.autores | join: ", " }}  
**País:** Ecuador | **Lengua:** Inglés | **Año de Publicación:** {{ page.ano_publicacao }}  
