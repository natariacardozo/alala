...
<h2 id="tag-title">Artigos sobre Avaliação de Libras (Língua Brasileira de Sinais)</h2>
...
<div id="posts-list">
  ...
  {% endfor %}
  <p id="empty-msg" style="display: none; color: #666; font-style: italic;">Nenhum registro encontrado para este idioma.</p>
</div>

<script>
  (function() {
    // Procura por "libras" ou pelo nome completo com e sem acento
    const alvos = ["libras", "língua brasileira de sinais", "lingua brasileira de sinais"]; 
