...
<h2 id="tag-title">Mapeamento: colombia</h2>
...
<script>
  // Script ajustado para reconhecer 'colombia' automaticamente nesta página
  (function() {
    const tagAlvo = "colombia"; 
