---
layout: default
title: "Mapeamento: Uruguai"
permalink: /pais/uruguai
---
...
<h2 id="tag-title">Mapeamento: Uruguai</h2>
...
<script>
  (function() {
    const tagAlvo = "uruguai"; // Define o filtro para esta página
    ...
    if (encontrados === 0) {
      titleEl.innerText = "Nenhum registro encontrado para: Uruguai";
    }
  })();
</script>
