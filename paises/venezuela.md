---
layout: default
title: "Mapeamento: Venezuela"
permalink: /pais/venezuela
---
...
<h2 id="tag-title">Mapeamento: Venezuela</h2>
...
<script>
  (function() {
    const tagAlvo = "venezuela"; // Filtro específico para a Venezuela
    ...
    if (encontrados === 0) {
      titleEl.innerText = "Nenhum registro encontrado para: Venezuela";
    }
  })();
</script>
