...
<h2 id="tag-title">Mapeamento: Cuba</h2>
...
<script>
  (function() {
    const tagAlvo = "cuba"; // Define o filtro para esta página
    ...
    if (encontrados === 0) {
      titleEl.innerText = "Nenhum registro encontrado para: Cuba";
    }
  })();
</script>
