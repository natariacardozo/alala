---
layout: default
title: "Mapeamento: Argentina"
permalink: /pais/argentina
---
...
<h2 id="tag-title">Mapeamento: Argentina</h2>
...
<script>
  (function() {
    const tagAlvo = "argentina"; // Define o filtro para esta página
    ...
    if (encontrados === 0) {
      titleEl.innerText = "Nenhum registro encontrado para: Argentina";
    }
  })();
</script>
