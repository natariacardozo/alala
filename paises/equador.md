---
layout: default
title: "Mapeamento: Equador"
permalink: /pais/equador
---
...
<h2 id="tag-title">Mapeamento: Equador</h2>
...
<script>
  (function() {
    const tagAlvo = "equador"; // Filtro específico para o Equador
    ...
    posts.forEach(post => {
      ...
      // Verifica as variações "equador" ou "ecuador" para garantir a captura
      if (postTags.includes(tagAlvo.toLowerCase()) || postTags.includes("ecuador")) {
    ...
    if (encontrados === 0) {
      titleEl.innerText = "Nenhum registro encontrado para: Equador";
    }
  })();
</script>
